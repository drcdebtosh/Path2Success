...
<nav class="navbar navbar-expand-lg bg-color py-4 pt-lg-5">
    <div class="container">
        <a class="navbar-brand text-white fw-bold " >Path2Success</a>
...
<section class=" services-section">
    <div class="container text-center common-title fw-bold">
        <h2 class="common-heading">What We Will Do For <br> Your Career Path</h2>
        ...
        <div class="row g-5 ">
            <div class="col-xxl-4 col-lg-4 col-12 ">
                <div class=" card-box rounded-2 p-5 text-center shadow ">
                    ...
                    <h5 class="my-3 fw-normal "> Test Yourself</h5>
                    <p class="pe-3 mb-5">
            ...
            <div class="col-xxl-4 col-lg-4 col-12  ">
                <div class=" card-box rounded-2 p-5 text-center shadow">
                    ...
                    <h5 class="my-3 fw-normal"> Random2 </h5>
                    <p class="pe-3 mb-5">
                        Hunky dory barney fanny around up the duff no biggie loo cup of tea jolly good ruddy say arse!
                    </p>
                    <div class="  d-flex justify-content-center align-items-center ">
            ...
            <div class="col-xxl-4 col-lg-4 col-12 ">
                <div class=" card-box rounded-2 p-5 text-center shadow">
                    ...
                    <h5 class="my-3 fw-normal "> Random3 </h5>
                    <p class="pe-3 mb-5">
                        Hunky dory barney fanny around up the duff no biggie loo cup of tea jolly good ruddy say arse!
                    </p>
                    <div class="  d-flex justify-content-center align-items-center ">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 xol-lg-6 col-md-12 col-12  d-flex flex-column justify-content-center align-items-start ">
                ...
                <h1 class="common-heading text-capitalize fw-bolder text-white">
                    Steps to Build a <br> Successful Career
                </h1>
                <p class="mt-3 mb-5 para-width text-light-grey">
...
<section class="common-section mb-5 pt-5 bg-color" >
    <div class="container text-center common-title  ">
        <h2 class="common-heading text-white" id="about"><br>About Us</h2>
        <hr class="w-25 mx-auto">
    </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem; ">
                                    ...
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3 ">Random 1</p>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Random 2</p>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Random 3</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Random 4</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Random 5</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Random 6</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        <div class="footer-links">
                            ...
                            <ul class="text-light-grey list-unstyled d-flex flex-column gap-2">
                                <li><a aria-current="page" class="nav-link active" href="#">Home</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-12 ">
                    Copyright ©2023 All rights reserved. <span class="bg-theme"></span>
                </div>
